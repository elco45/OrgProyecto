...
BTree* btree_cliente= new BTree(50);
BTree* btree_linea= new BTree(75);
	    ...
	    if (!encontrado){
     	...
     	double T1=0;
	   	...
	   	if(encontrado){
		   	...
		   	cout<<"Total tarifa 1 "<<T1<<endl;
		    cout<<"Total tarifa 2 "<<T2<<endl;
		    cout<<"Total tarifa 3 "<<T3<<endl;
		  	inFile.close();
	   	}
