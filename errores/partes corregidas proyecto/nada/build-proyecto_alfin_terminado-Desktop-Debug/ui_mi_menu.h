/********************************************************************************
** Form generated from reading UI file 'mi_menu.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *mi_menu)
    {
        if (mi_menu->objectName().isEmpty())
            mi_menu->setObjectName(QStringLiteral("mi_menu"));
        mi_menu->resize(1030, 524);
        centralWidget = new QWidget(mi_menu);
        ...
        mi_menu->setCentralWidget(centralWidget);
        menuBar = new QMenuBar(mi_menu);
        menuBar->setObjectName(QStringLiteral("menuBar"));
        menuBar->setGeometry(QRect(0, 0, 1030, 25));
        mi_menu->setMenuBar(menuBar);
        mainToolBar = new QToolBar(mi_menu);
        mainToolBar->setObjectName(QStringLiteral("mainToolBar"));
        mi_menu->addToolBar(Qt::TopToolBarArea, mainToolBar);
        statusBar = new QStatusBar(mi_menu);
        statusBar->setObjectName(QStringLiteral("statusBar"));
        mi_menu->setStatusBar(statusBar);

        retranslateUi(mi_menu);
        ...
        QMetaObject::connectSlotsByName(mi_menu);
    } // setupUi

    void retranslateUi(QMainWindow *mi_menu)
    {
        mi_menu->setWindowTitle(QApplication::translate("mi_menu", "mi_menu", 0));
        bt_crear->setText(QApplication::translate("mi_menu", "Crear", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("mi_menu", "crear", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("mi_menu", "listar", 0));
        bt_buscar_con_ciudad_2->setText(QApplication::translate("mi_menu", "Buscar ->", 0));
        label_7->setText(QApplication::translate("mi_menu", "Ingrese codigo", 0));
        tabWidget_5->setTabText(tabWidget_5->indexOf(tab_13), QApplication::translate("mi_menu", "Ciudad", 0));
        label_8->setText(QApplication::translate("mi_menu", "Ingrese id", 0));
        bt_buscar_con_Cliente_2->setText(QApplication::translate("mi_menu", "Buscar ->", 0));
        tabWidget_5->setTabText(tabWidget_5->indexOf(tab_14), QApplication::translate("mi_menu", "Cliente", 0));
        label_9->setText(QApplication::translate("mi_menu", "Ingrese numero", 0));
        bt_buscar_con_linea_2->setText(QApplication::translate("mi_menu", "Buscar", 0));
        tabWidget_5->setTabText(tabWidget_5->indexOf(tab_15), QApplication::translate("mi_menu", "Lineas", 0));
        tabWidget_3->setTabText(tabWidget_3->indexOf(tab_12), QApplication::translate("mi_menu", "Con  Index", 0));
        label_10->setText(QApplication::translate("mi_menu", "Ingrese codigo", 0));
        bt_buscar_sin_ciudad_2->setText(QApplication::translate("mi_menu", "Buscar ->", 0));
        tabWidget_6->setTabText(tabWidget_6->indexOf(tab_17), QApplication::translate("mi_menu", "Ciudad", 0));
        label_11->setText(QApplication::translate("mi_menu", "Ingrese id", 0));
        bt_buscar_sin_cliente_2->setText(QApplication::translate("mi_menu", "Buscar ->", 0));
        tabWidget_6->setTabText(tabWidget_6->indexOf(tab_18), QApplication::translate("mi_menu", "Cliente", 0));
        label_12->setText(QApplication::translate("mi_menu", "Ingrese id", 0));
        bt_buscar_sin_linea_2->setText(QApplication::translate("mi_menu", "Buscar ->", 0));
        tabWidget_6->setTabText(tabWidget_6->indexOf(tab_19), QApplication::translate("mi_menu", "Linea", 0));
        tabWidget_3->setTabText(tabWidget_3->indexOf(tab_16), QApplication::translate("mi_menu", "Sin index", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("mi_menu", "buscar", 0));
        label_13->setText(QApplication::translate("mi_menu", "Ingrese id", 0));
        bt_buscar_ar_ciudad->setText(QApplication::translate("mi_menu", "Bucar", 0));
        tabWidget_7->setTabText(tabWidget_7->indexOf(tab_21), QApplication::translate("mi_menu", "ciudad", 0));
        label_14->setText(QApplication::translate("mi_menu", "Ingrese id", 0));
        bt_buscar_ar_cliente->setText(QApplication::translate("mi_menu", "Buscar", 0));
        tabWidget_7->setTabText(tabWidget_7->indexOf(tab_22), QApplication::translate("mi_menu", "Cliente", 0));
        label_15->setText(QApplication::translate("mi_menu", "Ingrese id", 0));
        bt_buscar_ar_linea->setText(QApplication::translate("mi_menu", "bucar", 0));
        tabWidget_7->setTabText(tabWidget_7->indexOf(tab_23), QApplication::translate("mi_menu", "lineas", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_20), QApplication::translate("mi_menu", "Buscar con arbol", 0));
        label_16->setText(QApplication::translate("mi_menu", "Ingrese id", 0));
        bt_eliminar_ciudad->setText(QApplication::translate("mi_menu", "Eliminar", 0));
        tabWidget_8->setTabText(tabWidget_8->indexOf(tab_25), QApplication::translate("mi_menu", "Ciudad", 0));
        bt_eliminar_cliente->setText(QApplication::translate("mi_menu", "Eliminar", 0));
        label_17->setText(QApplication::translate("mi_menu", "Ingrerse id", 0));
        tabWidget_8->setTabText(tabWidget_8->indexOf(tab_26), QApplication::translate("mi_menu", "Cliente", 0));
        label_18->setText(QApplication::translate("mi_menu", "Ingrese id", 0));
        bt_eliminar_linea->setText(QApplication::translate("mi_menu", "Eliminar", 0));
        tabWidget_8->setTabText(tabWidget_8->indexOf(tab_27), QApplication::translate("mi_menu", "Linea", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_24), QApplication::translate("mi_menu", "Eliminar", 0));
        label_19->setText(QApplication::translate("mi_menu", "ID Ciudad", 0));
        label_20->setText(QApplication::translate("mi_menu", "Nombre Ciudad", 0));
        bt_Agregar_ciudad->setText(QApplication::translate("mi_menu", "Agregar", 0));
        tabWidget_9->setTabText(tabWidget_9->indexOf(tab_29), QApplication::translate("mi_menu", "Ciudad", 0));
        bt_agregar_cliente->setText(QApplication::translate("mi_menu", "Agregar", 0));
        label_21->setText(QApplication::translate("mi_menu", "TextLabel", 0));
        label_22->setText(QApplication::translate("mi_menu", "TextLabel", 0));
        label_23->setText(QApplication::translate("mi_menu", "TextLabel", 0));
        label_24->setText(QApplication::translate("mi_menu", "TextLabel", 0));
        radio_agregar_cliente_m->setText(QApplication::translate("mi_menu", "M", 0));
        radio_agregar_cliente_f->setText(QApplication::translate("mi_menu", "F", 0));
        tabWidget_9->setTabText(tabWidget_9->indexOf(tab_30), QApplication::translate("mi_menu", "Cliente", 0));
        bt_agregar_linea->setText(QApplication::translate("mi_menu", "Agregar", 0));
        label_25->setText(QApplication::translate("mi_menu", "ID Cliente", 0));
        label_26->setText(QApplication::translate("mi_menu", "Numero de linea", 0));
        tabWidget_9->setTabText(tabWidget_9->indexOf(tab_31), QApplication::translate("mi_menu", "linea", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_28), QApplication::translate("mi_menu", "Agregar", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_32), QApplication::translate("mi_menu", "Modificar", 0));
        by_reindexar->setText(QApplication::translate("mi_menu", "Reindexar", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_33), QApplication::translate("mi_menu", "Index", 0));
        label_32->setText(QApplication::translate("mi_menu", "Ingrese id Cliente", 0));
        groupBox->setTitle(QApplication::translate("mi_menu", "                           Balance", 0));
        label_27->setText(QApplication::translate("mi_menu", "Total tarifa 0.05", 0));
        label_28->setText(QApplication::translate("mi_menu", "Total tarifa 0.04", 0));
        label_29->setText(QApplication::translate("mi_menu", "Total tarifa 0.01", 0));
        label_30->setText(QApplication::translate("mi_menu", "Suma total tarifa ", 0));
        bt_tarifas->setText(QApplication::translate("mi_menu", "Generar", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_34), QApplication::translate("mi_menu", "Tarifas", 0));
    } // retranslateUi

};

namespace Ui {
    class mi_menu: public Ui_mi_menu {};
} // namespace Ui
